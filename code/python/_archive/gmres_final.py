"""
GMRES (Generalized Minimal Residual) - Final Correct Implementation
====================================================================

Based on: Saad, Y., & Schultz, M. H. (1986). GMRES: A generalized 
...
def gmres(A, b, x0=None, tol=1e-6, max_iter=100, restart=10, return_history=False):
    ...
    Parameters:
    -----------
    A : array_like (N x N matrix)
    b : array_like (length N vector)
    ...
    while total_iter < max_iter:
        ...
        for j in range(m):
            ...
            if H[j + 1, j] < 1e-12:
                ...
                # Build R = H[0:j+1, 0:j+1] (upper triangular)
                k = j + 1  # Size of R
...
def test_gmres():
    ...
    print("="*60)
    print("Testing GMRES Implementation (Final Correct Version)")
    print("="*60)
